...
var (
	...
	// ErrRTPHeaderEncryptionModeChangeNotSupported indicates that the negotiated RTP header
	// extension encryption mode could not be applied to the already-started SRTP session.
