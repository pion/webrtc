...
func (c *Context) generateCounter(sequenceNumber uint16, s *ssrcState) []byte {
	counter := make([]byte, 16)

	binary.BigEndian.PutUint32(counter[4:], s.ssrc)
	binary.BigEndian.PutUint32(counter[8:], s.rolloverCounter)
