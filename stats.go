...
type Stats interface {
	// Timestamp returns the timestamp associated with this object.
	//
	// For statistics that came from a remote source (e.g., from received RTCP packets),
	// timestamp represents the time at which the information arrived at the local endpoint.
	Timestamp() StatsTimestamp
	// Type returns the object's StatsType
	Type() StatsType
	// ID returns a unique id that is associated with the component inspected to produce
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s CodecStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s CodecStats) Type() StatsType {
	return s.StatsBase.Type
}

// ID returns a unique id that is associated with the component inspected to produce
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s CodecStats) ID() string {
	return s.StatsBase.ID
}

// ReceivedRTPStreamStats contains stats measured at the receiving end of an RTP stream,
// known either because they're measured locally or transmitted via an RTCP Receiver
...
// RTPStreamStats contains stats that apply to any end of any RTP stream.
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s InboundRTPStreamStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s InboundRTPStreamStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s InboundRTPStreamStats) ID() string {
	return s.StatsBase.ID
}
...
// SentRTPStreamStats contains stats measured at the sending end of an RTP stream,
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s OutboundRTPStreamStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s OutboundRTPStreamStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s OutboundRTPStreamStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s RemoteInboundRTPStreamStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s RemoteInboundRTPStreamStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s RemoteInboundRTPStreamStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s RemoteOutboundRTPStreamStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s RemoteOutboundRTPStreamStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s RemoteOutboundRTPStreamStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s RTPContributingSourceStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s RTPContributingSourceStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s RTPContributingSourceStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s PeerConnectionStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s PeerConnectionStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s PeerConnectionStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s DataChannelStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s DataChannelStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s DataChannelStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s MediaStreamStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s MediaStreamStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s MediaStreamStats) ID() string {
	return s.StatsBase.ID
}

// MediaHandlerStats contains statistics related to a specific MediaStreamTrack's
// attachment to an RTPSender and the corresponding media-level metrics.
...
// AudioHandlerStats contains audio metrics related to a specific MediaStreamTrack's
// attachment to an RTPSender
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s AudioSenderStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s AudioSenderStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s AudioSenderStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s SenderAudioTrackAttachmentStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s SenderAudioTrackAttachmentStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s SenderAudioTrackAttachmentStats) ID() string {
	return s.StatsBase.ID
}

// VideoHandlerStats contains video metrics related to a specific MediaStreamTrack's
// attachment to an RTPSender
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s VideoSenderStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s VideoSenderStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s VideoSenderStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s SenderVideoTrackAttachmentStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s SenderVideoTrackAttachmentStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s SenderVideoTrackAttachmentStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s AudioReceiverStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s AudioReceiverStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s AudioReceiverStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s VideoReceiverStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s VideoReceiverStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s VideoReceiverStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s TransportStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s TransportStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s TransportStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s ICECandidatePairStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s ICECandidatePairStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s ICECandidatePairStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s ICECandidateStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s ICECandidateStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s ICECandidateStats) ID() string {
	return s.StatsBase.ID
}
...
// For statistics that came from a remote source (e.g., from received RTCP packets),
// timestamp represents the time at which the information arrived at the local endpoint.
func (s CertificateStats) Timestamp() StatsTimestamp {
	return s.StatsBase.Timestamp
}

// Type returns the object's StatsType
func (s CertificateStats) Type() StatsType {
	return s.StatsBase.Type
}
...
// this Stats object. Two Stats objects will have the same ID if they were produced
// by inspecting the same underlying object.
func (s CertificateStats) ID() string {
	return s.StatsBase.ID
}
